...
「Keep Climbing. Keep Thinking. Keep Loving.」的个人工坊，横跨技术、学业、职业与生活。目前包含：

- **Tech Stack · 技术栈** — 已内化的技术与知识，按学科 / 主题成体系沉淀：数学、人工智能、计算机基础、编程语言、软件工程、外语等。
- **Academics · 学业** — 学校相关：学习经验总结、按年级 / 学期归档的课程笔记与应试复习（目前已整理大一、大二的非水课及大三课程；每门课按速成、真题、知识点与作业组织），真题与作业的答案或提交内容默认折叠、可手动展开，以及科研（WIP）。
- **Career · 职业** — 实习、求职与职场思考，目前收录 2025 年末至 2026 年初的实习面经，以及秋招面经。
- **Love & Interests · 生活与兴趣** — 生活、爱好与情感随笔（WIP）。
- **Plan & Think · 计划与思考** — 目标、规划、复盘与方法论，目前收录 2025 年终总结。
