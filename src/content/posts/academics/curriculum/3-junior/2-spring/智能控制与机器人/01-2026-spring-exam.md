---
title: "2026 年春真题（回忆版）"
description: "BUAA《智能控制与机器人》2026 年春真题回忆与可折叠参考解析"
date: 2026-08-21
updated: 2026-08-23
tags: ["数学", "真题"]
---
...
建议先独立完成每个小问，再手动展开对应答案。折叠内容不是课程提供的官方标准答案，而是根据课程讲义和现有试题信息整理的参考解析，作答时可按分值压缩。
...
分别计算 $W_{xh}$、$W_{hh}$、$b_h$、$W_{hy}$、$b_y$ 的形状和参数数量。
