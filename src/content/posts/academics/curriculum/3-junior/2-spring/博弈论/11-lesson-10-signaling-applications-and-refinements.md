...
课件讨论的是一个两期垄断定价模型。产品质量可能为好 $G$ 或差 $B$；好产品给消费者带来的价值为 $X$，差产品的价值为 $0$。单位成本满足

$$
c_G>c_B.
$$

消费者第一期只观察价格。若第一期购买，就会在使用后知道质量；第二期好产品可按 $X$ 定价，差产品则没有市场。若第一期不买，第二期也不再购买。

因此，这里不能用“高价暗示高质量”的日常直觉。课件给出的分离思路恰好相反：

- 差质量厂商不生产；
- 好质量厂商第一期定一个足够低的价格 $p_1$，诱使消费者试用；
- 消费者把这个低价解释为好质量并购买；
- 质量被验证后，好质量厂商在第二期获得复购利润。

若未来收益贴现因子为 $\delta$，好质量厂商采用低价时的两期利润是
