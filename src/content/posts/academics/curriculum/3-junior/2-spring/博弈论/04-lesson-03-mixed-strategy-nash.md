...
设玩家 1、2 的收益矩阵分别为 $A\in\mathbb R^{m\times n}$、$B\in\mathbb R^{m\times n}$，混合策略分别为列向量 $x$、$y$，均衡收益记为 $\alpha$、$\beta$。考虑

$$
\begin{aligned}
\max_{x,y,\alpha,\beta}\quad
&x^\mathsf T(A+B)y-\alpha-\beta\\
\text{s.t.}\quad
&Ay\le \alpha\mathbf 1_m,\\
&x^\mathsf TB\le \beta\mathbf 1_n^\mathsf T,\\
&\mathbf 1_m^\mathsf Tx=1,\quad
\mathbf 1_n^\mathsf Ty=1,\\
&x\ge0,\quad y\ge0.
\end{aligned}
$$
...
$$
x^\mathsf TAy\le\alpha,
\qquad
x^\mathsf TBy\le\beta,
$$
