...
这是一位前人对 **2025 年春季期末考试考点**的简短回忆，不是原卷，也没有完整题干、分值、参数或官方答案。我只在原始信息允许的范围内补全概念和复习边界，不把“考过哪些知识”硬编成“原题具体怎么问”。
...
因此，我把这篇文章定位为“期末考点（前人回忆）”，不把它当作一份真题。复习时先按这份清单抓重点，再用[考前速成清单](/academics/curriculum/3-junior/2-spring/模式识别与机器视觉/15-exam-cram-checklist/)串起全课。
