...
课程考核在课件中列为平时大作业 $50\%$、笔试 $50\%$。推荐教材为张宝昌等的《机器学习与智能感知》。课件还安排了用梯度下降优化 Beale 函数的作业。课件原文另将“协同梯度下降（CoGradient Descent）”列为自学且不作要求；这不是常见的标准术语，结合上下文疑似指共轭梯度法（Conjugate Gradient），因此我保留原文并标出疑点，不把它当作规范名称。
