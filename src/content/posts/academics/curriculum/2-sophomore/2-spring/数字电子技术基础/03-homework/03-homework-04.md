...
本篇对应 `2025作业文件/作业4.docx`，并合并同题的 `作业4.pdf` 与两页带批改作答。PDF 补出了 DOCX 文本抽取时漏掉的 2.3 题号。
...
把 $G_2$ 的悬空输入改接 $0.3\text{ V}$ 后，$G_2$ 的输出改为高电平，源作答四种情况下均记为约 $3.6\text{ V}$。
