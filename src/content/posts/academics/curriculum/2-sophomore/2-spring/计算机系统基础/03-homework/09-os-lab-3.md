...
description: "OS 2025 Lab 3 的实验要求与原实验报告，涉及进程控制块、地址空间、ELF 装载、异常入口和调度。"
date: 2026-08-27
tags: ["作业"]
---
...
报告把难点概括为两条：一是中断与异常的完整链路——异常分发、处理与现场恢复；二是时钟中断或主动调度如何进入调度器、判断是否切换进程、重置计数并运行新进程。第一次实现时很迷茫，熟悉完整流程后才逐渐能够把各段代码串起来。
