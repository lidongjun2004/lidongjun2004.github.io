...
description: "我当时提交的作业：Newton 环、等倾干涉和相干长度计算；题目在外，答案默认折叠。"
date: 2026-08-27
tags: ["作业"]
---
...
我当时从反射光暗纹条件出发，把透镜抬升造成的附加空气层厚度计入光程差，再用移动前的第 20 环消去曲率半径。提交中给出的结果为
...
我当时进一步利用移动前后同一视场边缘对应同一 $\theta$，并结合亮环数目，得到：
