---
title: "第 15–16 周作业 · 广义积分"
description: "教学日历第 15–16 周教材作业，合并源文件《第十六周题.pdf》中的手写提交与教师批注。"
date: 2026-08-27
tags: ["作业"]
---

教学日历把习题 9.1、9.2 列为第 15 周作业，把习题 9.3、9.4 列为第 16 周作业；源提交文件名是《第十六周题.pdf》，实际作答覆盖习题 9.1、9.2、9.4。这里保留两套周次并合并成一篇：全部原题放在折叠外，带红色批改痕迹的手写提交放在对应题目之后，不把被批错的推导替换成标准答案。习题 9.3 没有书面提交，其中第 4、5 题在教学日历中注明为阅读题，仍保留完整题面。源文件首尾空白页不作为题目展示。
