---
title: "第 13 周作业 · 微积分基本定理"
description: "教学日历第 13 周教材作业，题目来自教材习题 7.3。"
date: 2026-08-27
tags: ["作业"]
---
...
4. $\displaystyle\int_{-2}^{-1}\frac1{x\sqrt{x^2-1}}\,dx$；
...
函数 $f(x)$ 在 $[0,+\infty)$ 上连续，且 $\lim_{x\to+\infty}f(x)=a$。证明
...
设函数 $f(x)$ 在 $[0,1]$ 上连续且 $f(x)>0$。试将下面的极限表示为积分形式：
...
$$
\int_0^{\pi/2}(\sin\theta-\cos\theta)\ln(\sin\theta+\cos\theta)\,d\theta=0.
$$
