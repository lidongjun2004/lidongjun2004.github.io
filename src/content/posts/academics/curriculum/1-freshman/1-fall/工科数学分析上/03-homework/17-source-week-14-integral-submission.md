---
title: "第 14 周主观作业提交 · 定积分"
description: "源文件《第十四周题.pdf》的手写提交转录，题面按教材习题 7.2 与 7.3 还原。"
date: 2026-08-27
tags: ["作业"]
---
...
设 $f(x)$ 是 $[a,b]$ 上的有界函数，其不连续点为 $x_n$（$n=1,2,\ldots$），且 $\lim_{n\to\infty}x_n=c$。证明 $f(x)$ 在 $[a,b]$ 上可积。
